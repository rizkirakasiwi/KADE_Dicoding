...
class SearchTeamAdapter(val team: Teams):RecyclerView.Adapter<MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = MyViewHolder(
        LayoutInflater.from(parent.context).inflate(R.layout.team_ui, parent, false)
    )
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        view.setOnClickListener {
            ...
            it.findNavController().navigate(R.id.action_search_to_detailTeam)
        }
