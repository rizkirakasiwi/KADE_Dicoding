...
class NextMatchAdapter (val match: Match):RecyclerView.Adapter<MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        GlobalScope.launch(Dispatchers.Main){
            ...
            view.txt_centerText_matchLayout.text = view.context.getString(R.string.vs)
            ...
            val favoriteMatch = LoadFavoriteFromLocalDatabase(view.context).match("NextMatch")
